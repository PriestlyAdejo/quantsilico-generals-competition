"""Pre-game serving sanity probe for the RC_R1_BRIDGE gameplay arbiter.
...
experiments/marathon/rc_r1_bridge/<ARM>/raw.npz. Must
...
CANDIDATES = {
    "rc1_s1": REPO / "baselines/rc1_s1/main.py",
    "rc1_s2": REPO / "baselines/rc1_s2/main.py",
}
CHECKPOINTS = {
    "rc1_s1": REPO
    / "experiments/marathon/rc_r1_bridge/RC-R1-BRIDGE-S1/raw.npz",
    "rc1_s2": REPO
    / "experiments/marathon/rc_r1_bridge/RC-R1-BRIDGE-S2/raw.npz",
}
BASELINE_NPZ = (
    Path.home()
...
def main() -> int:
    ...
    distinct = float(np.max(np.abs(loaded["rc1_s1"] - loaded["rc1_s2"])))
