...
CANDIDATES = {
    "scale_a0_8m_s1": REPO / "baselines/scale_a0_8m_s1/main.py",
    "scale_a0_8m_s2": REPO / "baselines/scale_a0_8m_s2/main.py",
}
CHECKPOINTS = {
    "scale_a0_8m_s1": REPO
    / "experiments/marathon/screening_runs/STAGE5-SCALE-R1/SCALE-A0-8M-S1/raw.npz",
    "scale_a0_8m_s2": REPO
    / "experiments/marathon/screening_runs/STAGE5-SCALE-R1/SCALE-A0-8M-S2/raw.npz",
}
...
def main() -> int:
    ...
    distinct = float(np.max(np.abs(loaded["scale_a0_8m_s1"] - loaded["scale_a0_8m_s2"])))
