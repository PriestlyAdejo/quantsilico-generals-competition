"""Register the SH-R2 screening round as a canonical experiment record.
...
PLAN = REPO / "experiments/marathon/screening_round_2_plan.yaml"
...
def main() -> int:
    ...
    seeds = sorted({seed for arm in plan["arms"] for seed in arm["seeds"]})
    ...
    record = {
        ...
        "LINEAGE": lineage,
        "CONFIG_IDENTITY": {
            "plan": "experiments/marathon/screening_round_2_plan.yaml",
            "plan_kind": plan["kind"],
