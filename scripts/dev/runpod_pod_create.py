...
POD_NAME = "quantisilico_sh_r1_a40"
...
def build_input(data_center_id: str, public_key: str) -> dict:
    return {
        "cloudType": "SECURE",
...
def main() -> int:
    ...
    if args.dry_run:
        sample = build_input(DC_IDS[0], "<redacted local public key>")
    ...
    for dc_id in DC_IDS:
        payload = {"query": MUTATION, "variables": {"input": build_input(dc_id, public_key)}}
        try:
