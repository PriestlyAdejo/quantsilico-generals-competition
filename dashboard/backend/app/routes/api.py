...
def models() -> dict[str, Any]:
    ...
    models_out = [
        ...
        {
            "id": "cnn_bc_init_seed11",
            "architecture": "recurrent_cnn",
            "lifecycle": "EVALUATED",
            "competitive_role": "CHALLENGER",
            "delivery_status": "NOT_PACKAGED",
            "checkpoint": "experiments/checkpoints/initial/initial_cnn_cnn_bc_init_seed11/chunk_0/model.json",
            "compatibility": "CPU_COMPATIBLE" if cpu.get("all_ok") else "UNKNOWN",
            ...
            "losses": 0,
            "notes": [
                "INITIAL frozen checkpoint; Phase 9D draw-conversion lineage",
                "NOT PACKAGED — LEARNED PROMOTION HAS NOT PASSED",
            ],
        },
        {
            "id": "graph_bc_init_seed7",
            "architecture": "recurrent_graph_belief",
            "lifecycle": "EVALUATED",
            "competitive_role": "CHALLENGER",
            "delivery_status": "NOT_PACKAGED",
            "checkpoint": "experiments/checkpoints/initial/initial_graph_graph_bc_init_seed7/chunk_0/model.json",
            "compatibility": "CPU_COMPATIBLE" if cpu.get("all_ok") else "UNKNOWN",
