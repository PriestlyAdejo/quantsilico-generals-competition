...
PRESETS: dict[str, QualificationPreset] = {
    ...
    "development_a": QualificationPreset(
        name="development_a",
        seed_file="experiments/seeds/development_a.txt",
        seeds=8,
        paired_positions=True,
        max_turns=1200,
        opponents=("official_expander",),
        label="development_group_a",
    ),
    "development_b": QualificationPreset(
        name="development_b",
        seed_file="experiments/seeds/development_b.txt",
        seeds=8,
        paired_positions=True,
        max_turns=1200,
        opponents=("official_expander",),
        label="development_group_b",
    ),
    "development_c": QualificationPreset(
        name="development_c",
        seed_file="experiments/seeds/development_c.txt",
        seeds=8,
        paired_positions=True,
        max_turns=1200,
        opponents=("official_expander",),
        label="development_group_c",
    ),
