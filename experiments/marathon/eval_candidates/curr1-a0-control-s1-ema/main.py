"""RAW-VS-EMA candidate: CURR1-A0-CONTROL-S1 terminal EMA checkpoint.

PPO_SEMANTICS: EVAL_ONLY. Serves frozen EMA weights deterministically through
the parity-proven JAX serving path (EV-0019, EV-0034 adapter). Same training
run as curr1-a0-control-s1 (raw); only the served weight lineage differs.
"""
...
CHECKPOINT = Path(__file__).resolve().parent / "weights" / "ema.npz"
